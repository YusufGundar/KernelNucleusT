...
#define KNST_WINDOW_ATTRIB_DECORATED      0   
#define KNST_WINDOW_ATTRIB_RESIZABLE      1   
#define KNST_WINDOW_ATTRIB_ALWAYS_ON_TOP  2   
#define KNST_WINDOW_ATTRIB_TRANSPARENT    3   
